...
{
    echo "<div style='padding: 50px 30px; width: 80%; margin: 50px auto; border-radius: 10px; background-color: rgba(244,67,54 ,0.2); color: #f44336; font-family: sahel,sans-serif;'>$msg</div>";
    die();
}
...
function dd($data)
{
    echo "<pre style='text-align:left;direction:left;color: #455A64;font-size: 18px;position:relative;background-color:#ffffff;border-radius:10px;z-index: 999;margin: 10px;padding: 20px;border-left: 5px solid #2196F3;'>";
    var_dump($data);
    echo "</pre>";
}
